...
const WhatsAppFAB = () => {
  const whatsappUrl = "https://wa.me/905422640122?text=" + encodeURIComponent("Merhaba IFPIX, web sitesi çözümleriniz ve reklam hizmetleriniz hakkında bilgi almak istiyorum.");
